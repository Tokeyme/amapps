...
const I18N = {
  en: {
    ...
    meta_desc: "Independent apps for iOS and Android by Andreas Maier.",
    hero_tagline: "Independent apps for iOS & Android",
    hero_sub: "A small, growing collection of apps I design and build myself — simple, focused, and made with care.",
  ...
  de: {
    ...
    meta_desc: "Unabhängige Apps für iOS und Android von Andreas Maier.",
    hero_tagline: "Unabhängige Apps für iOS & Android",
    hero_sub: "Eine kleine, wachsende Sammlung von Apps, die ich selbst gestalte und entwickle — einfach, fokussiert und mit Sorgfalt gemacht.",
    hero_by: "von Andreas Maier",
    apps_heading: "Die Apps",
    btn_appstore: "App Store",
    btn_googleplay: "Google Play",
    app_converter_name: "Umrechner AM",
    app_converter_desc: "Ein klarer, schneller Einheiten- und Währungsrechner — Längen, Gewichte, Temperaturen, Währungen und mehr, alles an einem Ort.",
    app_podcast_name: "Podcast AM",
    ...
    app_feste_name: "Feste AM",
    app_feste_desc: "Finde Feste und Veranstaltungen in deiner Region — auch offline. Startgebiet: Ostalb.",
